                ...
                <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-steps">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/steps-1.jpg" class="img-fluid" alt="Сходинки 1">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-pressed-grating">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/pressed-grating-1.jpg" class="img-fluid" alt="Пресований решітчастий настил 1">
                            <div class="portfolio-info">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-welded-grid-decing">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/welded-grid-decing-1.jpg" class="img-fluid" alt="Зварний решітчастий настил 1">
                            <div class="portfolio-info">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-steps">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/steps-2.jpg" class="img-fluid" alt="Сходинки 2">
                            <div class="portfolio-info">
                                <h4>Сходинки 2</h4>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-pressed-grating">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/pressed-grating-2.jpg" class="img-fluid" alt="Пресований решітчастий настил 2">
                            <div class="portfolio-info">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-welded-grid-decing">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/welded-grid-decing-2.jpg" class="img-fluid" alt="Зварний решітчастий настил 2">
                            <div class="portfolio-info">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-steps">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/steps-3.jpg" class="img-fluid" alt="Сходинки 3">
                            <div class="portfolio-info">
                                <h4>Сходинки 3</h4>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-pressed-grating">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/pressed-grating-3.jpg" class="img-fluid" alt="Пресований решітчастий настил 3">
                            <div class="portfolio-info">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-welded-grid-decing">
                        <div class="portfolio-content h-100">
                            <img src="/<?= PATH_ASSETS; ?>img/projects/welded-grid-decing-3.jpg" class="img-fluid" alt="Зварний решітчастий настил 3">
                            <div class="portfolio-info">
